...
#ifndef SAS_CHECKERS_ROOTCCRN10_H
#define SAS_CHECKERS_ROOTCCRN10_H
...
namespace sas {
 namespace CodingConventions{
  namespace ROOT {
    class RN10Traits : public CommonCheckerTraits{
    public:
    ...
    class RN10Checker : public SasChecker<RN10Traits, clang::ento::check::ASTDecl<clang::VarDecl>>
    {
    public:
